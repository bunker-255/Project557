...
import { 
  ...
  Target, Info, ChevronRight, CreditCard
} from 'lucide-react';
            ...
            <div className="space-y-16">
              {retreat.schedule.map((item, i) => (
                <motion.div 
                  ...
                  className="relative flex flex-col md:flex-row items-start md:items-center gap-6 md:gap-12 md:pr-48"
                >
                  {/* Timeline Point */}
                  <div className="absolute right-[33px] md:right-[56px] top-4 md:top-auto w-4 h-4 rounded-full bg-brand-900 border-4 border-white shadow-lg z-10 flex-shrink-0"></div>
      ...
      <section className="py-40 bg-brand-900 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center text-white">
          ...
          <div className="bg-white/10 backdrop-blur-3xl p-16 md:p-24 rounded-[5rem] border border-white/20 max-w-4xl mx-auto mb-16 shadow-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-8 flex-wrap justify-center">
              {retreat.paymentLink && (
                  <motion.a 
                    ...
                    className="flex-grow bg-brand-500 text-white py-8 rounded-[2rem] font-black text-3xl flex items-center justify-center gap-4 hover:bg-brand-400 transition-all shadow-[0_20px_50px_rgba(194,142,115,0.4)] order-1 sm:order-none"
                  >
                    <CreditCard size={40} />
                    הרשמה ותשלום
                  </motion.a>
              ...
              <motion.a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex-grow bg-white text-brand-900 py-8 rounded-[2rem] font-black text-3xl flex items-center justify-center gap-4 hover:bg-brand-50 transition-all shadow-[0_20px_50px_rgba(255,255,255,0.2)] order-2 sm:order-none"
              >
                <MessageCircle size={40} />
                דברי איתי ונתאם
              </motion.a>
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="flex-grow order-3 sm:order-none">
                <Link 
                  to="/retreats"
