...
export const WHATSAPP_URL = "https://wa.me/972546691999?text=%D7%94%D7%99%D7%99%20%D7%9C%D7%99,%20%D7%90%D7%A0%D7%99%20%D7%9E%D7%A2%D7%95%D7%A0%D7%99%D7%99%D7%A0%D7%AA%20%D7%91%D7%A4%D7%A8%D7%98%D7%99%D7%99%D7%9D%20%D7%A2%D7%9C%20%D7%94%D7%A8%D7%99%D7%98%D7%A8%D7%99%D7%98%D7%99%D7%9D";
...
export const INSTAGRAM_URL = "https://www.instagram.com/talsharabi_holistictherapy?igsh=NGRqOWo2Y2R2bDN5&utm_source=qr";
export const TIKTOK_URL = "https://www.tiktok.com/@talsharabiholistichealth?_r=1&_t=ZS-92d1B6AuYg1";
export const FACEBOOK_URL = "https://www.facebook.com/share/17B1o8vHj1/?mibextid=wwXIfr";
...
export const SITE_CONTENT: SiteContent = {
  ...
  about: {
    ...
    paragraphs: [
      ...
      "מאז ומתמיד אהבתי ללמוד ולחקור את העולם בו אנו חיים, להקשיב, להסתכל על החיים och על הסיפור שכל אחד מאיתנו מספר דרך זוויות שונות. המכנה המשותף הברור של כל מה אני עושה הוא אחד: לתת למטופלים שלי כלים ממוקדים להתגבר על קשיים, משברים ואתגרים פיזיים ורגשיים בחייהם."
    ],
    specialties: [
...
export const RETREATS: RetreatContent[] = [
  {
    ...
    heroImage: IMAGES.session5_all,
    paymentLink: "https://meshulam.co.il/s/2e50fa20-b45e-fda3-7532-6103cc342870",
    intro: [
    ...
    audience: {
      ...
      points: [
        ...
        "למי שמבקשת לעצור את המירוץ, להתחבר פנימה ולקבל כלים לחיים מאוזנים יותר."
      ]
    },
...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    imageUrl: IMAGES.nia,
    fullDescription: [
      "NIA, ראשי תיבות של Now I Am, היא שיטה מדהימה לתנועה ולריקוד, שמחברת בין רעיונות שונים מעולמות היוגה, הפלדנקרייז, שיטת אלכסנדר, אמנויות לחימה ובין מחול.",
...
export const TESTIMONIALS: Testimonial[] = [
  ...
  {
    id: '3',
    text: "בוקר אור 😍 ההרגשה מצוינת!! אני מרגישה מלאה בביטחון, חזקה פיזית וריגשית יותר מאי פעם ועוצמתית 💪🏻 יש יותר שקט בלב, אמונה והוקרת תודה. הצוואר בהרבה יותר טוב במיוחד בצד ימין הכל משוחרר ולא תקוע התנועה חלקה! בצד שמאל יש שיפור גדול. ישנתי 6 וחצי שעות כי קמתי ללימודים ומרגישה כאילו ישנתי לפחות 10.. תודה על הכל אהובה ❤️ תבורכי 🙌י",
    author: "מטופלת"
  },
  {
    id: '4',
    text: "תקשיבי אין לי מילים באמת יצאתי באורות , תחושה מטורפת לא הצלחתי להירדם היו לי כאבי ראש אבל בלילה ישנתי ממש טוב ובכללי כל החווייה איתך גם מעבר לנשימות היה מושלם אני שמחה שהכרתי אותך ושזאת תחילת הדרך איתך 🥰🥰",
    author: "מטופלת"
  }
];